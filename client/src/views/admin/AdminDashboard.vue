...
const menuItems = [
  ...
  { path: '/admin/seckill', label: '秒杀活动', icon: '⚡' },
  ...
  <div class="admin-layout">
    ...
    <aside class="admin-sidebar" :class="{ collapsed: isCollapse }">
      <div class="sidebar-header">
        ...
        <span v-if="!isCollapse" class="sidebar-title">优购管理后台</span>
      </div>
    ...
    <div class="admin-main">
      ...
      <header class="admin-header">
        <div class="header-left">
          <h3 class="page-title">{{ menuItems.find(m => m.path === activeMenu)?.label || '管理后台' }}</h3>
        </div>
        <div class="header-right">
          <el-dropdown @command="(cmd: string) => { if (cmd === 'logout') handleLogout() }">
            <div class="admin-avatar">
              <div class="avatar-circle-sm">管</div>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item disabled>
                  <span style="color:#999;font-size:12px">管理员账号</span>
                </el-dropdown-item>
                <el-dropdown-item divided command="logout" style="color:#e1251b">
